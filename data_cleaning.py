...
for i in range (len(corpus)):
    ...
    # corpus[i] = word_tokenize(corpus[i])
    print_time("Cleaned document " + str(i))
...
print_time("File data_cleaning.py executed")